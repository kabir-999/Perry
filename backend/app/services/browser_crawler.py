...
_MIN_MEMORY_MB_TO_CONTINUE = 220
...
async def browser_crawl(
    ...
    *,
    ...
    if settings.SCAN_PROFILE.strip().lower() == "lite":
        msg = (
            "Browser crawl disabled by SCAN_PROFILE=lite to keep the scan "
